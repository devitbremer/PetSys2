                      ...
                      <form action="" method="POST" class="col s12">
                        <div class="row">
                          ...
                          <div class="row card-panel" id="table">
                            <div class="col s12 m12 l12">
                              <div class="row">
                                  <h4 class="header">Pets Cadastrados</h4>
                              </div>
                                    ...
                                    <?php
                                      ...
                                      if(isset($_POST['Pesquisar'])){
                                        ...
                                        while($dados = mysql_fetch_array($result)){
                                          echo '<tr>';
                                            echo '<td>';
                                              echo '<p class ="bold">Cod: </p>'.$dados['id_pet'];
                                            echo '</td>';
                                            echo '<td>';
                                              echo '<p class ="bold">Nome: </p>'.$dados['nome_pet'];
                                            echo '</td>';
                                            echo '<td>';
                                              echo '<p class ="bold">Nasc: </p>'.$dados['nascimento'];
                                            echo '</td>';
                                            echo '<td>';
                                              echo '<p class ="bold">Peso: </p>'.$dados['peso'].' kg';
                                            echo '</td>';
                                            echo '<td>';
                                              echo '<p class ="bold">Tipo: </p>'.$dados['nome_tipo'];
                                            echo '</td>';
                                            echo '<td>';
                                              echo '<p class ="bold">Raça: </p>'.$dados['raca'];
                                            echo '</td>';
                                            echo '<td>';
                                              echo '<p class ="bold">Gênero: </p>'.$dados['sexo'];
                                            echo '</td>';
                                            echo '<td>';
                                              echo '<p class ="bold">Tutor: </p>'.$dados['nome_tutor'];
                                            echo '</td>';
                                            echo '<td>';
