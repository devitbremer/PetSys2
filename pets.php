            ...
            <?php
                ...
                if(isset($_POST['Salvar'])){
                  ...
                  $query = "INSERT INTO animal(nome, nascimento, id_tipo, raca, peso, id_tutor, sexo) VALUES ('$nome_pet','$nascimento','$tipo','$raca','$peso', '$id_tutor', '$sexo' )";
                    ...
                    if ($executar) {
                    echo '<script type="text/javascript">Materialize.toast("<span class=&quot;blue-text&quot;>Salvo!</span>",5000)</script>';
                    //echo '<script type="text/javascript">alert("salvo!")</script>';
                    } else {
                    echo '<script type="text/javascript">Materialize.toast("<span class=&quot;red-text&quot;>Algo errado aconteceu!</span>",5000)</script>';
                    }
                 } 
